...
# -------------------------------------------------------
# 문자/글자 안에서 일부분만 추출해서 다루기 => 슬라이싱
# - 원소 / 요소 추출 규칙/문법 => 변수명[시작인덱스 : 끝인덱스+1 : 간격]
# - 조건 : 연속된 인덱스 또는 규칙이 있는 인덱스
# -------------------------------------------------------
# Happy만 화면에 출력하기 (슬라이싱)
print(f'msg[0:5] : {msg[0:5]}')  # 0~4

# 2024!만 화면에 출력하기 (슬라이싱)
print(f'msg[15:20] : {msg[15:20]}')
print(f'msg[-5:20] : {msg[-5:20]}')   # 음수 인덱스, 양수 인덱스 섞어 쓸 수 있다.
...
print(f'msg[:] : {msg[:]}')
print(f'msg[0:-1] : {msg[0:-1]}')   # 이게 되네??? ㅋㅋㅋ???
...
# msg 안에서 2, 4, 6, 8 요소만 출력 (규칙 : 인덱스 간격 2씩 증가)
